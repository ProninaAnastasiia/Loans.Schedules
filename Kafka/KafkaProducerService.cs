...
namespace Loans.Schedules.Kafka;
...
public class KafkaProducerService
{
    ...
    public async Task PublishAsync(string topic, string message)
    {
        ...
        try
        {
            ...
            _logger.LogInformation("Опубликовано сообщение в Kafka.  Topic: {Topic}, Partition: {Partition}, Offset: {Offset}, Message: {Message}", topic, result.Partition, result.Offset, message);
